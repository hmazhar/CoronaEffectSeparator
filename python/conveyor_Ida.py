...
# Assembly: C:\Users\admin\Dropbox\Cad_CES\Cad_ida_v2\CAD_conveyor\Assembly_Ida_aperto.SLDASM
...
body_1.SetInertiaXY(chrono.ChVectorD(-1.3656634769519e-35,1.59975608589952e-20,-4.47399006138433e-38))
body_1.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(1.01787213456557e-18,1.29343073635046e-34,0),chrono.ChQuaternionD(1,0,0,0)))
...
body_2.SetName('Splitter2-1')
body_2.SetPos(chrono.ChVectorD(0.416156012458144,0.286549383384347,-0.0817847646755439))
body_2.SetRot(chrono.ChQuaternionD(0.972369920397677,1.04672748231844e-16,-2.51297035050063e-17,0.233445363855904))
body_2.SetMass(0.169782296961291)
body_2.SetInertiaXX(chrono.ChVectorD(0.00159993103963307,0.00135874722183981,0.000411943807053511))
body_2.SetInertiaXY(chrono.ChVectorD(-0.00016598313102536,-1.37295174887671e-19,-2.82798192331859e-19))
body_2.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.00150058309966217,-0.0154834802535394,-2.77151895831939e-17),chrono.ChQuaternionD(1,0,0,0)))
...
marker_2_1.SetName('Splitter2')
body_2.AddMarker(marker_2_1)
marker_2_1.Impose_Abs_Coord(chrono.ChCoordsysD(chrono.ChVectorD(0.416156012458144,0.286549383384347,-0.0817847646755439),chrono.ChQuaternionD(0.972369920397677,1.04672748231844E-16,-2.51297035050063E-17,0.233445363855904)))
...
mr[0,2]=-1; mr[1,2]=0; mr[2,2]=0 
body_2.GetCollisionModel().AddBox(0.15,0.075,0.002,chrono.ChVectorD(0.002,1.38777878078145E-17,0),mr)
...
body_3.SetInertiaXY(chrono.ChVectorD(-1.139974266205e-09,-1.39829340327407e-20,7.78620863795044e-20))
body_3.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.00150052115485541,-0.0159825459116232,6.09985024552931e-19),chrono.ChQuaternionD(1,0,0,0)))
...
body_4.SetInertiaXY(chrono.ChVectorD(-1.00585162486448e-18,-8.4576255565448e-19,5.29526165579663e-20))
body_4.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.271211975438826,0.413994449049259,-1.66242648262179e-06),chrono.ChQuaternionD(1,0,0,0)))
...
body_5.SetInertiaXY(chrono.ChVectorD(-0.0883080169952972,0.0439356443408866,0.0345485433857678))
...
# Auxiliary marker (coordinate system feature)
marker_5_2 =chrono.ChMarkerShared()
...
body_5.GetCollisionModel().AddBox(0.0132511736464386,0.254046190843515,0.2035,chrono.ChVectorD(-0.401248638358623,-1.23094629097478,0.0315000593787049),mr)
mr = chrono.ChMatrix33D()
...
body_5.GetCollisionModel().AddBox(0.0292554789734579,0.249805368165055,0.2035,chrono.ChVectorD(-0.0617418466516264,-1.2267052816943,0.0314999958019597),mr)
mr = chrono.ChMatrix33D()
...
body_5.GetCollisionModel().AddBox(0.0197636915985527,0.250242141495163,0.2035,chrono.ChVectorD(0.209277316591803,-1.22714190001486,0.031499947373644),mr)
mr = chrono.ChMatrix33D()
...
body_5.GetCollisionModel().AddBox(0.0154140963254538,0.25013019465113,0.2035,chrono.ChVectorD(0.467954961389621,-1.22702981403608,0.0314999008291813),mr)
mr = chrono.ChMatrix33D()
mr[0,0]=0; mr[1,0]=1; mr[2,0]=0 
mr[0,1]=0; mr[1,1]=0; mr[2,1]=-1 
mr[0,2]=-1; mr[1,2]=0; mr[2,2]=0 
...
body_6.SetName('conveyor-1')
body_6.SetPos(chrono.ChVectorD(-0.0627155647639022,0.0534995314229745,-0.0817847646755438))
body_6.SetRot(chrono.ChQuaternionD(1,0,0,0))
body_6.SetMass(3.8327249391131)
body_6.SetInertiaXX(chrono.ChVectorD(0.029314394817887,0.0796399719369236,0.0514634926681141))
body_6.SetInertiaXY(chrono.ChVectorD(0.000230401673820675,-3.24335481703772e-18,3.22384926541676e-19))
body_6.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.0716568005336428,0.52112990089967,-6.6372987649813e-19),chrono.ChQuaternionD(1,0,0,0)))
body_6.SetBodyFixed(1)
...
marker_6_1.SetName('centro_nastro')
body_6.AddMarker(marker_6_1)
marker_6_1.Impose_Abs_Coord(chrono.ChCoordsysD(chrono.ChVectorD(0.00849641067492329,0.587493980472233,-0.0817847646755438),chrono.ChQuaternionD(1,0,0,0)))
...
mr[0,2]=0; mr[1,2]=0; mr[2,2]=-1 
body_6.GetCollisionModel().AddBox(0.193724352473189,0.001,0.15,chrono.ChVectorD(0.0785377577161679,0.554163002941846,0),mr)
...
#   Entity 1: C::E name: body_6 , SW name: conveyor-1 ,  SW ref.type:4


# Mate constraint: Distance1 [MateDistanceDim]
#   Entity 0: C::E name: body_6 , SW name: conveyor-1 ,  SW ref.type:2
...
link_1.Initialize(body_6,body_5,0,cA,cB,dB)
...
dB = chrono.ChVectorD(-3.54919571694725e-15,-1,-5.5180472374077e-15)
link_2.SetFlipped(1)
link_2.Initialize(body_6,body_5,0,cA,cB,dA,dB)
...
link_3.Initialize(body_6,body_5,0,cA,cB,dB)
...
dB = chrono.ChVectorD(-1,-5.20742506859829e-17,5.20742506859829e-17)
link_4.SetFlipped(1)
link_4.Initialize(body_6,body_5,0,cA,cB,dA,dB)
...
#   Entity 1: C::E name: body_6 , SW name: conveyor-1 ,  SW ref.type:2
...
#   Entity 0: C::E name: body_6 , SW name: conveyor-1 ,  SW ref.type:4
...
#   Entity 0: C::E name: body_3 , SW name: Splitter-10 ,  SW ref.type:4
#   Entity 1: C::E name: body_2 , SW name: Splitter2-1 ,  SW ref.type:4
...
#   Entity 0: C::E name: body_6 , SW name: conveyor-1 ,  SW ref.type:0
#   Entity 1: C::E name: body_1 , SW name: Spazzola-1 ,  SW ref.type:0
...
#   Entity 1: C::E name: body_2 , SW name: Splitter2-1 ,  SW ref.type:1
...
link_5.Initialize(body_5,body_2,0,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(0,-2.15294089288643e-16,1)
dB = chrono.ChVectorD(3.20474742746036e-31,-2.15294089288644e-16,1)
link_6.Initialize(body_5,body_2,0,cA,cB,dA,dB)
...
link_7.SetFlipped(1)
link_7.Initialize(body_5,body_3,0,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(0,2.15294089288643e-16,-1)
dB = chrono.ChVectorD(0,0,1)
link_8.Initialize(body_5,body_3,0,cA,cB,dA,dB)
